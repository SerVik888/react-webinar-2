        ...
        <>
          ...
          {data.comments.map((item) => (
            <Comment
              ...
              key={item._id}>
              {select.replyOpenStatus === item._id ? (
                <UserComment parentId={item._id} parentType={item._type} isDefault={false} />
              ) : (
                ''
              )}
            </Comment>
          ...
          {!select.replyOpenStatus ? (
            <UserComment parentId={params.id} parentType={'article'} isDefault={true} />
          ) : null}
        </>
      )}
    </Spinner>
